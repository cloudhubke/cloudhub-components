...
const staticColumns =[
     { name: 'actions', title: 'Actions',  width: 200 },
];
            ...
            if (column.name === 'actions') {
                return (
                    <TableCell>
                        ...
                        <IconButton onClick={()=>this.props.onDelete(row)} title="Delete row">
                            <DeleteIcon />
                        </IconButton>
                    </TableCell>
                );
        ...
        return (
            <div className="grid-container">
                ...
                >
                    ...
                    <DialogActions>
                        <Button onClick={this.props.onCancelDelete} color="primary">Cancel</Button>
                        <Button onClick={()=>{
